...
function renderBracket(byNum) {
  ...
  // R32 groups interleaved accordingly: (M74,M77)→M89, (M83,M84)→M93, etc.
  const ROUNDS = [
    { label: "1/16", nums: [74,77, 83,84, 73,75, 81,82, 76,78, 85,86, 79,80, 87,88] },
    { label: "1/8",  nums: [89,93, 90,94, 91,95, 92,96] },
